...
- **Tracks B/C/D — Experiment lab (Phases 11–16):** model bench + router (B), guardrails (C), RAG variants: agentic + graph (D). Target: **August → mid/late September 2026**, part-time, finishing before peak fall recruiting. The commit history, `PROGRESS.md`, and ADRs are the receipts that this genuinely spanned July–September; do not compress or backdate anything.
...
Do not proceed past a phase until its AC pass. Track A unchanged from v1 (compressed here — full detail in v1 remains valid). **Today is mid-July: Track A lands by end of July; Tracks B/C/D run August → mid/late September, comfortably before peak recruiting.**

### TRACK A — Core product (complete by ~Jul 31)
...
### TRACK B — Models & routing (~Aug weeks 1–3)
...
### TRACK C — Guardrails (~Aug weeks 3–4)
...
### TRACK D — RAG variants (~Sep weeks 1–3)
