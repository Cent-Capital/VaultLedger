...
![Latency–quality frontier](adr0023_agentic_baseline_frontier.svg)
...
|---|---:|---|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `ollama/qwen3:8b` | 8.2B | `Q4_K_M` | 5.75 GiB | `D_agentic` | t=0, p=0.95, k=20, max=768 | — | 6 | 26 | 46.2% | 42.3% | 45.8% (n=24) | 42.3% | 42.3% | 20765 ms | 41515 ms | 19272 ms | 40646 ms | 80930 / 11745 | $0.000000 | `matrix_ollama_qwen3_8b_d_agentic_t0_p0p95_6a82bd327b6e` |
...
|---|---|---|---|---:|---|---:|---:|---:|---:|---:|
| `ollama/qwen3:8b` | `D_agentic` | t=0, p=0.95, k=20, max=768 | — | 6 | `aggregation` | 14 | 50.0% | 58.3% (n=12) | 50.0% | 50.0% |
| `ollama/qwen3:8b` | `D_agentic` | t=0, p=0.95, k=20, max=768 | — | 6 | `multi_hop` | 12 | 33.3% | 33.3% (n=12) | 33.3% | 33.3% |
...
Judge: `ollama/qwen3:8b` · coverage 100.0% · passes 12/26.
...
|---|---:|---:|---:|---:|---:|---:|
| `ollama/qwen3:8b` | 100.0% | 100.0% | 100.0% | 11.5% | 3.27 / 6 | 2864 |
