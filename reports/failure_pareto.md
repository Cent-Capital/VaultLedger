...
Repo `8f391566ab6f` · config `f8f9b3e473cf` · generated 2026-08-15T14:50:11.439711+00:00
...
| Run id | Reason |
|---|---|
| `matrix_ollama_qwen3_8b_d_agentic_t0_p0p95_6a82bd327b6e` | ran as the same-stack baseline for the rejected payload-only experiment (ADR-0024) |
| `matrix_ollama_qwen3_8b_d_agentic_t0_p0p95_861c711def89` | ran the empty-SQL-result contract the product does not ship (ADR-0022 rejected candidate) |
| `matrix_ollama_qwen3_8b_d_agentic_t0_p0p95_a4da2769451b` | ran the payload-only empty-result contract the product does not ship (ADR-0024 rejected candidate) |
